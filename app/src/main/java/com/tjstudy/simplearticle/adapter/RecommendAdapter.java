...
import com.tjstudy.simplearticle.ui.recommend.RecommendItemActivity;
...
public class RecommendAdapter extends RecyclerView.Adapter<RecommendAdapter.MyRecommendHolder> {
    List<Article> articles;
    Context mContext;

    public RecommendAdapter(List<Article> articles, Context mContext) {
        ...
        holder.holderView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (NetUtils.isConnected(mContext)) {
                    RecommendItemActivity.startActivity(mContext, article);
                } else {
